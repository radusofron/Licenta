...
def profile_view() -> Response:
    ...
    evaluated_percentage = profile_data["evaluated percentage"]
    evaluation_data = profile_data["evaluation data"]
    ...
    return make_response(
        render_template("profile.html", user_profile_data = user_profile_data, has_profile_picture = has_profile_picture, visited_percentage = visited_percentage, 
                        visited_destinations_graph_data = visited_destinations_graph_data, evaluated_percentage = evaluated_percentage, 
